...
<head>
  ...
  <title>PHP MYSQL AJAX CRUD WITH BOOTSTRAP 5 AND DATATABLE LIBRARY</title>
  <!-- bootstrap css-->
...
<body>
  <nav class="navbar justify-content-center fs-3 mb-3 " style="background-color:#00ff5573;">PHP AJAX CRUD application
  </nav>
  <div class="container">
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasAddUser" style="width: 600px;">
    ...
    <div class="offcanvas-body">
      <r method="POST" id="insertForm">
        <div class="row mb-3">
          <div class="col">
            <label  for="firstname">First Name</label>
            <input type="text" class="form-control" name="first_name"id="firstname" placeholder="enter your first_name">
          </div>
          <div class="col">
            <label for="lastname" class="form-label">Last Name</label>
            <input type="text" class="form-control" name="last_name"id="lastname" placeholder="enter your last_name">
          </div>
        </div>
        ...
        <div class="row mb-3">
          <label  for="image" class="form-lable">upload image</label>
          <div class="col-2">
            <img class="preview_img" src="images/image.png">
          </div>
          <div class="col-10">
